...
function lib:Create(ver, size, hidekey)
	...
	MainFrame.BackgroundColor3 = Color3.fromRGB(2, 9, 21)
	...
	PromptContainer.BackgroundColor3 = Color3.fromRGB(2, 8, 15)
    ...
    MainGlow.ImageColor3 = Color3.fromRGB(9, 165, 239)
	MainGlow.ImageTransparency = 0.15
	...
	PromptBackground.BackgroundColor3 = Color3.fromRGB(2, 9, 21)
	...
	PromptStroke.Color = Color3.fromRGB(38, 54, 72)
   ...
   --PromptTitle.Text = "<font color='rgb(107, 89, 222)'><font size='20'>»</font></font>  " .. tostring(thetext)
	...
	PromptSepTop.BackgroundColor3 = Color3.fromRGB(23, 33, 44)
	...
	PromptSepBottom.BackgroundColor3 = Color3.fromRGB(23, 33, 44)
	...
	PromptYesButton.BackgroundColor3 = Color3.fromRGB(7, 31, 40)
	...
	PromptNoButton.BackgroundColor3 = Color3.fromRGB(7, 31, 40)
	...
	PromptYesButton.MouseEnter:Connect(function()
		game.TweenService:Create(PromptYesButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(17, 73, 94)}):Play()
	end)
	
	PromptYesButton.MouseLeave:Connect(function()
		game.TweenService:Create(PromptYesButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(7, 31, 40)}):Play()
	end)--

	PromptYesButton.MouseButton1Down:Connect(function()
		game.TweenService:Create(PromptYesButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(7, 17, 30)}):Play()
	end)

	PromptYesButton.MouseButton1Up:Connect(function()
		game.TweenService:Create(PromptYesButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(17, 73, 94)}):Play()
	end)

	PromptNoButton.MouseEnter:Connect(function()
		game.TweenService:Create(PromptNoButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(17, 73, 94)}):Play()
	end)
	
	PromptNoButton.MouseLeave:Connect(function()
		game.TweenService:Create(PromptNoButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(7, 31, 40)}):Play()
	end)

	PromptNoButton.MouseButton1Down:Connect(function()
		game.TweenService:Create(PromptNoButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(7, 17, 30)}):Play()
	end)

	PromptNoButton.MouseButton1Up:Connect(function()
		game.TweenService:Create(PromptNoButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(17, 73, 94)}):Play()
	end)
	...
	MainFrameShadow.ImageColor3 = Color3.fromRGB(45, 91, 122)
	MainFrameShadow.ImageTransparency = 0.400
    ...
    LeftBarBack.BackgroundTransparency = 0.55
	LeftBarBack.BackgroundColor3 = Color3.fromRGB(23,33,44)
	...
	LeftBarBackCR.BackgroundColor3 = Color3.fromRGB(1, 10, 22)
    LeftBarBackCR.BackgroundTransparency = 0.65
	...
	LeftBarBackLine.BackgroundColor3 = Color3.fromRGB(1,10,22)
	...
	TopBar.BackgroundColor3 = Color3.fromRGB(2, 9, 21)
	...
	TopBarLine.BackgroundColor3 = Color3.fromRGB(20, 31, 42)
    ...
    ProfileStroke.Color = Color3.fromRGB(66, 96, 127)
	...
	SearchBack.BackgroundColor3 = Color3.fromRGB(31, 50, 70)
	...
	SearchBox.PlaceholderColor3 = Color3.fromRGB(100, 162, 225)
	SearchBox.PlaceholderText = "Search..."
	SearchBox.Text = ""
	SearchBox.TextColor3 = Color3.fromRGB(100, 162, 225)
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(100, 162, 225)
	...
	SearchBackLine.BackgroundTransparency = 0.5
	...
	function tabs:Tab(title, AssID, desc1, desc2)
		...
		TabHighlight.BackgroundColor3 = Color3.fromRGB(1,166,246)
		TabHighlight.BackgroundTransparency = 0.25
		...
		PageFade.BackgroundColor3 = Color3.fromRGB(5,14,28)
		...
		function subtabs:SubTab(title, AssID)
			...
			SubTabBtnOutline.BackgroundColor3 = Color3.fromRGB(32, 79, 100)
			...
			SubTabBtnInline.BackgroundColor3 = Color3.fromRGB(2, 9, 21)
			...
			SubTabBtnInteract.MouseEnter:Connect(function()
				game.TweenService:Create(SubTabBtnOutline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(12, 114, 166)}):Play()
			end)
			
			SubTabBtnInteract.MouseLeave:Connect(function()
				game.TweenService:Create(SubTabBtnOutline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(32, 79, 100)}):Play()
			end)

			SubTabBtnInteract.MouseButton1Down:Connect(function()
				game.TweenService:Create(SubTabBtnOutline, TweenInfo.new(0.075, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(4, 55, 83)}):Play()
			end)
			...
			SubPageFade.BackgroundColor3 = Color3.fromRGB(4,13,26)
			...
			SubTabBtnInteract.MouseButton1Click:Connect(function()
				...
				for i, v in next, AllSubTabBtns:GetDescendants() do
					if v.Name == 'SubTabBtnInline' then
						game.TweenService:Create(v, TweenInfo.new(lib.Animations.AnimSpeed, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(2, 9, 21)}):Play()
					end
				end
				game.TweenService:Create(SubTabBtnInline, TweenInfo.new(lib.Animations.AnimSpeed, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(29, 46, 65)}):Play()
			end)
			...
			function items:Label(side, text, image)
				...
				LabelArrows.Text = "»"
				LabelArrows.TextColor3 = Color3.fromRGB(27,59,109)
				LabelArrows.TextSize = 20
				LabelArrows.TextXAlignment = Enum.TextXAlignment.Left
				
				local LabelGradient = Instance.new("UIGradient")
				LabelGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(27, 43, 65)),ColorSequenceKeypoint.new(0.08, Color3.fromRGB(32, 50, 71)),ColorSequenceKeypoint.new(1.00, Color3.fromRGB(32, 50, 71))}
			...
			function items:Toggle(side, text, config, callback) -- text off / 146, 158, 171
				...
				ToggleTitle.TextColor3 = Color3.fromRGB(146, 158, 171)
				...
				ToggleFrameBack.BackgroundColor3 = Color3.fromRGB(20, 29, 39)
				...
				ToggleFrameCircle.BackgroundColor3 = Color3.fromRGB(125,138,148)
				...
				ToggleInteract.MouseButton1Click:Connect(function()
					...
					if toggled == false then
						...
						TweenService:Create(ToggleFrameCircle, TweenInfo.new(lib.Animations.ElementsAS, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),  {BackgroundColor3 = Color3.fromRGB(6,168,232)}):Play()
						TweenService:Create(ToggleFrameBack, TweenInfo.new(lib.Animations.ElementsAS, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(2, 16, 34)}):Play()
					else
						toggled = false
						TweenService:Create(ToggleTitle, TweenInfo.new(lib.Animations.ElementsAS, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(146, 158, 171)}):Play()
						...
						TweenService:Create(ToggleFrameCircle, TweenInfo.new(lib.Animations.ElementsAS, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),  {BackgroundColor3 = Color3.fromRGB(125, 138, 148)}):Play()
						TweenService:Create(ToggleFrameBack, TweenInfo.new(lib.Animations.ElementsAS, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(20, 29, 39)}):Play()
					end
			...
			function items:Colorpicker(side, text, preset, callback)
				...
				Colorpicker.BackgroundColor3 = Color3.fromRGB(2, 9, 21)
				...
				ColorpickerFrame.BackgroundColor3 = Color3.fromRGB(11, 20, 30) --27, 42, 53
				...
				UIStroke13.Color = Color3.fromRGB(112, 112, 112)
				...
				UIStroke_3.Color = Color3.fromRGB(33, 102, 134)
            ...
            function items:Button(side, text, callback, callback_2, prompttitle, promptmessage)
				...
				ButtonUIStroke.Color = Color3.fromRGB(0, 77, 125)
				ButtonUIStroke.Thickness = 0.9
                ...
                ButtonFrame.MouseEnter:Connect(function()
					TweenService:Create(ButtonFrame, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(0, 157, 255)}):Play()
					TweenService:Create(ButtonUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color = Color3.fromRGB(0, 157, 255)}):Play()
				end)
        
				ButtonFrame.MouseLeave:Connect(function()
					TweenService:Create(ButtonFrame, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(2, 9, 21)}):Play()
					TweenService:Create(ButtonUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color = Color3.fromRGB(0, 77, 125)}):Play()
				end)

                ButtonFrame.MouseButton1Down:Connect(function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(103, 165, 253)}):Play()
				end)

                ButtonFrame.MouseButton1Up:Connect(function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(142, 171, 245)}):Play()
				end)
			...
			function items:Bind(side, text, mode, callback)
				...
				KeybindFrame.BackgroundColor3 = Color3.fromRGB(2, 16, 34) --23, 33, 44
				KeybindFrame.BackgroundTransparency = 0.9
				...
				KeybindFrameStroke.Color = Color3.fromRGB(23, 68, 95)
			...
			function items:Textbox(side, text, placeholdertext, clearafter, callback)
				...
				TextBoxFrame.BackgroundColor3 = Color3.fromRGB(2, 16, 34)
			...
			function items:Slider(side, text, start, min, max, inc, callback)
				...
				SlideBack.BackgroundColor3 = Color3.fromRGB(2, 16, 34)
				...
				SlideCircle.BackgroundColor3 = Color3.fromRGB(9, 165, 239)
				...
				SlideBackLight.BackgroundColor3 = Color3.fromRGB(39, 93, 111)
                --SlideBackLight.BackgroundTransparency = 0
				...
				SliderValue.BackgroundColor3 = Color3.fromRGB(26, 47, 70)
				...
				SliderValStroke.Color = Color3.fromRGB(0, 157, 255)
                ...
                function SetStart(val)
					...
					--[[ with animation:
					SlideBackLight:TweenSize(UDim2.new((val or 0) / max, 0, 1, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 3, true)
					SlideCircle:TweenPosition(UDim2.new((val or 0) / max, 0, 1, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 3, true)]]
			...
			function items:Dropdown(side, text, default, options, cb, multi)
				...
				DropdownDropFrame.BackgroundColor3 = Color3.fromRGB(26, 47, 70) --3, 18, 28
				DropdownDropFrame.BackgroundTransparency = 0.9
				...
				DropdownDropFrameArrowHolder.BackgroundColor3 = Color3.fromRGB(3, 28, 58)
				...
				DropStroke.Color = Color3.fromRGB(23, 68, 95)
				...
				DropdownChildFrameOutline.BackgroundColor3 = Color3.fromRGB(26, 47, 70)
				...
				DropdownChildFrame.BackgroundColor3 = Color3.fromRGB(1, 9, 21)
				...
				DropdownInteract.MouseEnter:Connect(function()
					TweenService:Create(DropdownDropFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 0.65}):Play()
				end)
				DropdownInteract.MouseLeave:Connect(function()
					TweenService:Create(DropdownDropFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 0.9}):Play()
				end)
				...
				for _, opt in next, options do
					...
					DropdownBtn.BackgroundColor3 = Color3.fromRGB(1, 9, 21) -- 22, 20, 45, edit
					...
					DropdownBtn.MouseEnter:Connect(function()
						game.TweenService:Create(DropdownBtn, TweenInfo.new(.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(34, 59, 81)}):Play()
					end)
					DropdownBtn.MouseLeave:Connect(function()
						game.TweenService:Create(DropdownBtn, TweenInfo.new(.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(1, 9, 21)}):Play()
					end)
				end
...
function lib:Notify(title, desc, dur)
	...
	Notification.BackgroundColor3 = Color3.fromRGB(2, 9, 21)
	...
	NotificationBack.BackgroundColor3 = Color3.fromRGB(2, 9, 21)
	...
	NotificationShadow.ImageColor3 = Color3.fromRGB(9, 165, 239)
	...
	NotificationLine.BackgroundColor3 = Color3.fromRGB(3, 21, 44)
	...
	NotificationDurationLine.BackgroundColor3 = Color3.fromRGB(6, 104, 149)
    ...
    NotificationGlow.ImageColor3 = Color3.fromRGB(9, 165, 239)
	NotificationGlow.ImageTransparency = 0.3
	...
	coroutine.wrap(function()
		...
		game.TweenService:Create(NotificationBack, TweenInfo.new(lib.Animations.AnimSpeed, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Position = UDim2.new(1, 20, 0.5, 0)}):Play()
		for i,v in next, NotificationBack:GetChildren() do
			if v:IsA('Frame') then
